...
const makeRequestBtn = document.createElement('button')
makeRequestBtn.innerText = 'make request'
...
changeStyleBtn.innerText = 'change style'
changeStyleBtn.addEventListener('click', () => {
    document.body.classList.toggle("changingStyle")
})

document.body.append(makeRequestBtn, changeStyleBtn)